...
fun EditText.requestFocusWithKeyboard() {
  Log.d("sima","requestFocusWithKeyboard")
...
fun showReminderInMap(context: Context,
  ...
  Log.d("sima","showReminderInMap");

  if (reminder.latLng != null) {

    Log.d("sima","showReminderInMap(if)");
...
fun sendNotification(context: Context, message: String, latLng: LatLng) {
  ...
  if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O
    ...
    Log.d("sima","sendNotification after version check")
